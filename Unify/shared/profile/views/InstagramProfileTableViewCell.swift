//
//  InstagramProfileTableViewCell.swift
//  Unify
//
...
class InstagramProfileTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        contentView.backgroundColor = UIColor.instagramBlue()
        
        setUpLabels(name, username: username, description: userDescription, numFollowers: numFollowers, numFollowing: numFollowing, numPosts: numPosts)
    }
    
    func setUpLabels(name: String, username: String, description: String, numFollowers: String, numFollowing: String, numPosts: String) {
        nameLabel.text = name
